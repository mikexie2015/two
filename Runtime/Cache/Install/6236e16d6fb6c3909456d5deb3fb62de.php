...
<html>
    <head>
        ...
        <link href="/two/Public/Install/css/install.css" rel="stylesheet">

        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="assets/js/html5shiv.js"></script>
        <![endif]-->
        <script src="/two/Public/static/jquery-1.10.2.min.js"></script>
        <script src="/two/Public/static/bootstrap/js/bootstrap.js"></script>
    </head>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/two/install.php?s=/install/step2.html" method="post" target="_self">
