...
return array(
    ...
    /* 后台错误页面模板 */
    'TMPL_ACTION_ERROR'     =>  TMPL_PATH.MODULE_NAME.'/Public/error.html', // 默认错误跳转对应的模板文件
    'TMPL_ACTION_SUCCESS'   =>  TMPL_PATH.MODULE_NAME.'/Public/success.html', // 默认成功跳转对应的模板文件
    'TMPL_EXCEPTION_FILE'   =>  TMPL_PATH.MODULE_NAME.'/Public/exception.html',// 异常页面的模板文件
